<template>
  <div class="index">
    <div class="head">
      <h1 class="head_title">ui_beam的图标库</h1>
      <h4 class="head_txt">
        提供在线图标链接，用于个人NAS设备显示使用，禁止用于商业用途
      </h4>
      <h4 class="head_txt">开源项目，By ui_beam</h4>
      <div class="use">
    ...
    <div class="foot">
      <div class="foot_txt">© 2024.3.1 | By ui_beam</div>
      <div class="foot_url">
...
export default defineComponent({
  setup() {
    ...
    async function handleClick(url) {
      ...
      let iconurlCdn = "https://oss.mikutechnology.cn/images/" + "icons/" + url;
